...
const Skills = () => {
  return (
    <div name='skills' className='w-full h-screen bg-[#066565] text-gray-300'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div className='mt-[90%] md:mt-[10%]'>
          ...
          <div className='grid w-full grid-cols-2 gap-4 py-8 text-center sm:grid-cols-4'>
              ...
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  <img className='w-20 mx-auto' src={D3} alt="HTML icon" />
                  <p className='my-4'>D3 JS</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
